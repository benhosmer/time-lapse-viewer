...
<div class = "modal" id = "helpDialog">
	<div class = "modal-dialog">
		<div class = "modal-content">
			...
			<%--<div class = "modal-body"><g:render template = "../../../../plugins/networkSpecific/grails-app/views/home/helpDialog"/></div>--%>
			<div class = "modal-body"><g:render template="helpDialog" plugin="networkSpecific"/></div>
